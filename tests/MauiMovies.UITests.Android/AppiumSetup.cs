...
public class AppiumSetup : IDisposable
{
	...
	public AppiumSetup()
	{
		...
		var androidOptions = new AppiumOptions
		{
			...
			// App = Path.Join(TestContext.CurrentContext.TestDirectory, "../../../../MauiApp/bin/Release/net8.0-android/com.companyname.applicationname-Signed.apk"),
		...
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppPackage, "com.mauimovies");

		//Make sure to set [Register("com.companyname.applicationname")] on the MainActivity of your android application
		androidOptions.AddAdditionalAppiumOption(AndroidMobileCapabilityType.AppActivity, $"com.mauimovies.MainActivity");
